...
public class PanelBotonesAgregar extends JPanel implements ActionListener
{
    ...
    public PanelBotonesAgregar( VentanaAgregarRestaurante ventanaPrincipal )
    {
        ...
        // TODO completar
        butNuevo = new JButton("Crear restaurante"); //crear al boton
        butNuevo.setActionCommand(CREAR); //establecerle el grito
        butNuevo.addActionListener(this); //decir quien lo va a escuchar

        // Agrga el boton para cerrar la ventana
        // TODO completar
        butCerrar = new JButton("Cerrar");
        butCerrar.setActionCommand(CERRAR); //establecer el grito
        butCerrar.addActionListener(this); //decir quien lo va a escuchar
